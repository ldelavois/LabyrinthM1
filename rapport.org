...
#+AUTHOR: Ludovic DELAVOIS, Julien MASSONNEAU, Amelozara Mahazoasy, Matthias PAULMIER
...
modèle *MVC* était le but premier de celui-ci. Enfin, certains membres
du groupe ont dû apprendre à utiliser GitHub (pour le travail collaboratif) qu'ils n'ont pas utilisé auparavant.
